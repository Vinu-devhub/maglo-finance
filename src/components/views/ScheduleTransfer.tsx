    ...
    <Card className="col-span-3 text-white bg-transparent border-none space-y-6 px-2">
      <CardHeader className=" p-0">
        <div className=" flex justify-between items-center">
          <CardTitle className=" font-semibold">Scheduled Transfers</CardTitle>
          <Button className=" text-base font-semibold bg-transparent hover:bg-transparent border-none text-accentColor gap-2 p-0">
